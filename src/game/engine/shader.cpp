...
void Shader::set(const std::string& name, float value_1, float value_2) noexcept {
    use();
    glUniform2f(glGetUniformLocation(m_shader, name.c_str()), value_1, value_2);
}
...
void Shader::set(const std::string& name, float value_1, float value_2, float value_3) noexcept {
    use();
    glUniform3f(glGetUniformLocation(m_shader, name.c_str()), value_1, value_2, value_3);
}
...
void Shader::set(const std::string& name, glm::mat3 value) noexcept {
    use();
    glUniformMatrix3fv(glGetUniformLocation(m_shader, name.c_str()), 1, GL_FALSE, glm::value_ptr(value));
}
